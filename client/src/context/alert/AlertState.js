...
const AlertState = props => {
	...
	//	-----------> inside onSubmit, in Register, I will pass 'setAlert("Please enter all fields", "danger")'; this returns a red title with the message inside
